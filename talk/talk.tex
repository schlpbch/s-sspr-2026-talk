...
\begin{frame}[plain]
  ...
  {\usebeamerfont{institute}\usebeamercolor[fg]{institute}%
    ...
    {\color{ascTeal600}asc.engineering}\quad\textbullet\quad
    arXiv:2606.08322\par}
  \vspace{0.55cm}
...
\begin{frame}{Kernel PCA turns 28}
  \muted{Sch\"olkopf, Smola \& M\"uller, \emph{Nonlinear component analysis as
  a kernel eigenvalue problem}, Neural Computation, 1998.}
  \vspace{0.35cm}

  \bigstatement{For 28 years, the question has been:\\
    \emph{which} kernel reveals the nonlinearity?}
  \vspace{0.3cm}
  \bigstatement{\color{ascTeal600}How do you certify that a dataset contains none?}
  \vspace{0.35cm}
...
\begin{frame}{The Case Under Audit}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \textbf{Renold et al., J.\ Air Transport Management, 2023}
      \vspace{0.15cm}
      \begin{itemize}
        \item US airline profit cycles, \textbf{1995--2020}
        \item Seven variables: operating profit, fuel, wages, RPM,
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \textbf{Two risks left unexamined}
      \vspace{0.1cm}
      \begin{enumerate}
...
\begin{frame}{Seven Variables, 2.46 Effective Dimensions}
  ...
  spectrum --- how many dimensions actually carry signal.
  \vspace{0.2cm}
  \begin{equation*}
...
\begin{frame}{Linear PCA vs.\ RBF kernel PCA}
  ...
  \vspace{0.15cm}
  \begin{itemize}
    \item \teal{\ari{} = 1.000}: all 26 observations land in identical
...
\begin{frame}{The linearity Certificate, as a Checklist}
