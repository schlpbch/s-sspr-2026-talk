...
\begin{frame}[plain]
  ...
  \vspace{0.30cm}
  {\large\muted{The linearity certificate: How to show a dataset has no kernel.}\par}
  \vspace{0.85cm}
...
\begin{frame}{Future Work}
  ...
  \begin{itemize}
    ...
    \item Hint: Railways have profit cycles too.
  \end{itemize}
\end{frame}
...
\begin{frame}[plain]
  ...
  \muted{Kernel PCA, 28 years on, works as the audit tool for its own linear ancestor.}
